    ...
    public class SongPlayer : ISongPlayer, IDisposable
    {
        ...
        public void Update()
        {
            while (_running)
            {
                ...
                if (_currentSong != null && !_currentSong.Song.IsInfinite && _queue.Count < minimalsonginqueue + ((int)(DateTime.Now - _currentSongStart).TotalSeconds + 20 > _currentSong.Song.Duration ? 1 : 0))
                {
